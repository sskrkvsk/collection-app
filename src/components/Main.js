...
const Main = () => {
  ...
  function handleSave() {
    ...
    axios.post('https://sskrkvsk.github.io/editCategory', { editedName: newName, oldName :editableTable })
      .then(response => {
  ...
  function handleDelete(tableName) {
    ...
    axios.post('https://sskrkvsk.github.io/deleteCategory', {category :tableName}).then(response => {
    })
    .catch(error => {
      console.error("Error posting data:", error);
    });
